  ...
  return (
    <div className={'bg-cover h-full'}>
      ...
      <div className='flex flex-col gap-y-24'>
        ...
        <div className={'w-full bg-white border-1 border-pr-200 rounded-4 flex-grow flex-shrink-0  h-[calc(100vh-224px)] p-20 font-soyoThin font-normal text-14 overflow-y-scroll'}>
